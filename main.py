...
DEFAULT_SEARCH_MARKUP = [
                    ...
                    [InlineKeyboardButton("👨‍💻Updates channel ", url="https://t.me/UbalataPissuda")]
                ]
...
async def start_handler(_, message: Message):
    try:
        await message.reply_sticker("CAADAQADJAMAAgh1tx7BMsiTzpTcJwI")
        await message.reply_text(
            text="😋Hello, Welcome! to @Quotees_Bot \n"
